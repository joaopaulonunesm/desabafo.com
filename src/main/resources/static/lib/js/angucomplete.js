...
angular.module('angucomplete', [] )
    .directive('angucomplete', function ($parse, $http, $sce, $timeout, $location) {
    return {
        restrict: 'EA',
        scope: {
            "id": "@id",
        ...
        link: function($scope, elem, attrs) {
            ...
            $scope.selectResult = function(result) {
                ...
                //redireciona para pagina do usuario clicado
                $location.path("/assunto/" + $scope.selectedObject.title);
            }
